...
function ServiceCard({ title, description, icon, color, onClick }: ServiceCardProps) {
  return (
    <div className={`relative flex h-full min-h-[280px] flex-col justify-between rounded-3xl p-8 ${color}`}>
      <div>
        <h3 className="mb-2 text-3xl font-bold text-slate-800 font-heading">{title}</h3>
    ...
    <div className="relative w-full py-16 px-4 md:px-8 lg:px-16 overflow-hidden bg-rekora-light-blue -mt-6">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <ServiceCard
            title="SCIENCE"
            description="Rekora challenges young minds with cool experiments, encouraging them to think critically and find smart solutions."
          ...
          <ServiceCard
            title="TECH"
            description="Rekora teaches how to use basic coding tools, build simple websites, and understand how everyday tech are made."
          ...
          <ServiceCard
            title="MATH"
            description="At Rekora, we help kids learn numbers, patterns and shapes by playing fun games and building things with their hands."
